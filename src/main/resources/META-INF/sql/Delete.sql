...
DELETE  FROM rdap.ip_network_parent_relation;

#38_delete_ipn_entity_roles
DELETE  FROM rdap.ipn_entity_roles;

#39_delete_ip_network_links
DELETE  FROM rdap.ip_network_links;

#40_delete_ip_network_remarks
DELETE  FROM rdap.ip_network_remarks;

#41_delete_ip_network_status
DELETE  FROM rdap.ip_network_status;

#42_delete_ip_network_events
DELETE  FROM rdap.ip_network_events;
